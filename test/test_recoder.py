import os
# Removed unused import: import shutil
import argparse
# Removed unused import: import logging
import unittest
from unittest import TestCase # Removed mock import
from irontorch.recoder import get_logger, Logger, WandB
# Removed unused import: import wandb
# Removed unused import: import irontorch.distributed as dist
...
class TestLogging(TestCase):
    ...
    def test_logger_rich(self):
        ...
        with self.assertLogs(self.logger_name, level="INFO") as log:
            ...
            self.assertIn(
                f"INFO:{self.logger_name}:step: 2 | accuracy: 0.96 | loss: 0.04",
                log.output,
            )
